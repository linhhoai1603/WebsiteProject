      ...
      <div class="header-right d-flex align-items-center justify-content-end mb-4">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item" href="product-zippers?option=1&page=1<c:if test='${minPrice != null || maxPrice != null}'>&amp;minPrice=${minPrice}&amp;maxPrice=${maxPrice}</c:if>">Mới nhất</a></li>
            <li><a class="dropdown-item" href="product-zippers?option=2&page=1<c:if test='${minPrice != null || maxPrice != null}'>&amp;minPrice=${minPrice}&amp;maxPrice=${maxPrice}</c:if>">Giá: Cao -> Thấp</a></li>
            <li><a class="dropdown-item" href="product-zippers?option=3&page=1<c:if test='${minPrice != null || maxPrice != null}'>&amp;minPrice=${minPrice}&amp;maxPrice=${maxPrice}</c:if>">Giá: Thấp -> Cao</a></li>
            <li><a class="dropdown-item" href="product-zippers?option=4&page=1<c:if test='${minPrice != null || maxPrice != null}'>&amp;minPrice=${minPrice}&amp;maxPrice=${maxPrice}</c:if>">Bán chạy nhất</a></li>
            <li><a class="dropdown-item" href="product-zippers?option=5&page=1<c:if test='${minPrice != null || maxPrice != null}'>&amp;minPrice=${minPrice}&amp;maxPrice=${maxPrice}</c:if>">Giảm giá: Cao -> Thấp</a></li>
          </ul>
        </div>
      </div>
            ...
            <div class="card product-item position-relative h-100">
              ...
              <div class="card-body text-center d-flex flex-column">
                ...
                <form action="cart?method=add" method="post" class="mt-auto product-options-form">
                  <!-- Hidden Inputs -->
                  <input type="hidden" name="currentURL" value="product-zippers?page=${currentPage}&option=${option}<c:if test='${minPrice != null || maxPrice != null}'> &amp;minPrice=${minPrice}&amp;maxPrice=${maxPrice}</c:if>">
